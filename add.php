	...
	<div class="container">
		<div class="content">
			...
			if(isset($_POST['add'])){
				...
				$cek = mysqli_query($con, "SELECT * FROM proveedor WHERE codigo='$codigo'");
				if(mysqli_num_rows($cek) == 0){
						$insert = mysqli_query($con, "INSERT INTO proveedor(codigo, nombres, empresa)
															VALUES('$codigo','$nombres', '$empresa')") or die(mysqli_error());
						if($insert){
			...
			<form class="form-horizontal" action="" method="post">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label">Empresa Proveedora</label>
					<div class="col-sm-4">
